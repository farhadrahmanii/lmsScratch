                    ...
                    <div class="card-body">
                        ...
                        <form method="post" class="row">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input id="phone" class="form-control form--control" value="{{Auth::user()->phone}}"
                                        type="tel" name="phone">
                                </div>
                            </div><!-- end input-box -->
                    </div><!-- end card-body -->
                        ...
                        <div class="payment-option-wrap">
                            <div class="payment-tab active">
                                <div class="payment-tab-toggle">
                                    <input checked="" id="directPayment" name="cash_delivery" type="radio"
                                        value="HandCash">
                            ...
                            <div class="payment-tab">
                                <div class="payment-tab-toggle">
                                    <input id="strip" name="strip" type="radio" value="Strip">
                                    <label for="strip">Strip Payment</label>
                                </div>
                            </div><!-- end payment-tab -->
                        </div>
                    </div><!-- end card-body -->
