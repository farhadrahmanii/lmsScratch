        ...
        <div class="row">
            <div class="mx-auto col-lg-7">
                <div class="card card-item">
                    <div class="card-body">
                        <h3 class="pb-4 text-center card-title fs-24 lh-35">Create an Account and <br> Start Learning!
                        </h3>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" id="name" type="text" name="name"
                                        :value="old('name')" required autofocus placeholder="Name" autocomplete="name">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input id="email" class="form-control form--control" placeholder="Email"
                            ...
                            <div class="input-box">
                                ...
                                <div class="mb-3 input-group">
                                    ...
                                    <input class="form-control form--control password-field" placeholder="Password"
                            ...
                            <div class="input-box">
                                <label class="password_confirmation">Confirmation Password</label>
                                <div class="mb-3 input-group">
                                    <span class="la la-lock input-icon"></span>
                            ...
                            <div class="btn-box">
                                ...
                                <p class="pt-2 fs-14">Already have an account? <a href="{{route('login')}}"
