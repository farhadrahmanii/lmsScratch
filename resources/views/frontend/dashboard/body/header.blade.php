                                                ...
                                                <ul class="cart-dropdown-menu after-none">
                                                    ...
                                                    <li>
                                                        <a href="my-courses.html" class="btn theme-btn w-100">Got to
                                                            wishlist <i class="ml-1 la la-arrow-right icon"></i></a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                                        ...
                                                        <div class="notification-body">
                                                            <a href="dashboard.html"
                                                                ...
                                                                <div class="media-body">
                                                                    ...
                                                                    <span class="pt-1 d-block lh-18 text-gray fs-13">1
                                                                        hour ago</span>
                                                                </div>
                                                            </a>
                                                            <a href="dashboard.html"
                                                    ...
                                                    <li class="menu-heading-block d-flex align-items-center">
                                                        ...
                                                        <div class="ml-2">
                                                            <h4><a href="teacher-detail.html"
                                                                    class="text-black">{{$userData->name}}</a></h4>
                                                            <span
                                                                class="d-block fs-14 lh-20">{{$userData->email}}</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div
