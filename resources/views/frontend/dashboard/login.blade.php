                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control" type="type" id="email" name="email"
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="mb-3 input-group">
                                        ...
                                        <input class="form-control form--control password-field" :value="old('password')"
                                ...
                                <div class="btn-box">
                                    ...
                                    <p class="pt-2 fs-14">Don't have an account? <a href="{{route('register')}}"
    ...
    <script>
        $(document).ready(function () {
            $("#email").on("keyup", function () {
                let email = $(this).val().trim(); // Trim spaces

                if (email.length === 0) {
                    return; // Don't make an AJAX call if the input is empty
                }
