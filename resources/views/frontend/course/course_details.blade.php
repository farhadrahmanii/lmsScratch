            ...
            <div class="breadcrumb-content">
                ...
                <div class="d-flex flex-wrap align-items-center">
                    <p class="pr-3 d-flex align-items-center">
                        ...
                        Last updated
                        {{ $course->updated_at == null ? $course->created_at->diffForHumans() : $course->updated_at->diffForHumans()  }}
                    </p>
                    <p class="pr-3 d-flex align-items-center">
                        <svg class="svg-icon-color-gray mr-1" width="16px" viewBox="0 0 24 24">
                            <path
                ...
                <div class="course-details-content-wrap pt-90px">
                    ...
                    <div class="course-overview-card">
                        ...
                        <ul class="generic-list-item generic-list-item-bullet fs-15">
                            {!! html_entity_decode($course->prerequisites) !!}
                        </ul>
                    </div><!-- end course-overview-card -->
                        ...
                        <div class="curriculum-header d-flex align-items-center justify-content-between pb-4">
                            ...
                            <div class="curriculum-duration fs-15">
                                <span class="curriculum-total__text mr-2"><strong
                                        class="text-black font-weight-semi-bold">Total:</strong> {{ count($lectures) }}
                                    lectures</span>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="heading{{$sectionItem->id}}">
                                            <button class="btn btn-link d-flex align-items-center justify-content-between"
                                                ...
                                                <span
                                                    class="fs-15 text-gray font-weight-medium">{{ $sectionItem->lectures->count() }}
                                                    lectures</span>
                                            </button>
                                        </div>
                                        <div id="collapse{{$sectionItem->id}}" class="collapse" aria-labelledby="headingOne"
                                            data-parent="#accordion">
                                            <div class="card-body">
                                                <ul class="generic-list-item">
                                                    @foreach ($sectionItem->lectures as $lectureItem)
                                                        <li>
                                                            <a href="#"
                            ...
                            <div class="media media-card">
                                <div class="instructor-img">
                                    <a href="teacher-detail.html" class="media-img d-block">
                                        <img class="lazy" src="{{!empty($course->user->photo)
    ? url('upload/instructor_images/' . $course->user->photo)
                ...
                <div class="sidebar sidebar-negative">
                        ...
                        <div class="card-body">
                            <div class="preview-course-video">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                    <img src="{{url($course->course_image)}}" data-src="{{url($course->course_image)}}"
                        ...
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item generic-list-item-flash">
                                ...
                                <li class="d-flex align-items-center justify-content-between"><span><i
                                    ...
                                    {{ $course->certificate == "YES" ? "YES" : "NO" }}</li>
                            </ul>
                        </div>
                    </div><!-- end card -->
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item">
                                @foreach ($categories as $categories_item)
                                    <li><a
                                            href="{{ url('/category/' . $categories_item->id . '/' . $categories_item->category_slug) }}">{{ $categories_item->category_name }}</a>
                                    </li>
                                @endforeach
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <div class="divider"><span></span></div>
                            @foreach ($category_courses as $cat_course_item)
                                                        <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                                            <a href="{{url('/course/details/' . $cat_course_item->id . '/' . $cat_course_item->course_name_slug)}}"
                                                                class="media-img">
                                                                <img class="mr-3 lazy" src="{{url($cat_course_item->course_image)}}"
                                                                    data-src="images/small-img-2.jpg" alt="Related course image">
                                                            </a>
                                                            <!-- discount calculator Start here -->
                                                            @php
                                                                $amount = $cat_course_item->selling_price - $cat_course_item->discount_price;
                                                                $discount = ($amount / $cat_course_item->selling_price) * 100;
                                                            @endphp
                                                            <!-- discount calculator Start here -->
                                                            <div class="media-body">
                                                                <h5 class="fs-15"><a
                                                                        href="course-details.html">{{$cat_course_item->course_name}}</a></h5>
                                                                <span class="d-block lh-18 py-1 fs-14">{{ $cat_course_item['user']['name'] }}</span>
                                                                @if ($cat_course_item->discount_price == NULL)
                                                                    <p class="text-black card-price font-weight-bold">
                                                                        ${{ $cat_course_item->selling_price }}
                                                                    </p>
                                                                @else
                                                                    <p class="text-black card-price font-weight-bold">
                                                                        ${{ $cat_course_item->discount_price }}
    ...
    <div class="container">
        <div class="related-course-wrap">
            ...
            <div class="view-more-carousel-2 owl-action-styled">
                @foreach ($instructorCourses as $ins_courses_item)
                                <div class="card card-item">
                                    <div class="card-image">
                                        <a href="{{route('course.details', [$ins_courses_item->id, $ins_courses_item->course_name_slug])}}"
                                            class="d-block">
                                            <img class="card-img-top" src="{{url($ins_courses_item->course_image)}}"
                                                alt="Card image cap">
                                        </a>
                                        <!-- Discount Process is here  -->
                                        @php
                                            $amount = $ins_courses_item->selling_price - $ins_courses_item->discount_price;
                                            $discount = ($amount / $ins_courses_item->selling_price) * 100;
                                        @endphp
                                        <!-- End Discount Process is here  -->
                                        <div class="course-badge-labels">
                                            @if ($ins_courses_item->bestseller == '1')
                                                <div class="course-badge">Bestseller</div>
                                            @endif

                                            @if ($ins_courses_item->highestrated == 1)
                                                <div class="course-badge sky-blue">Highest Rated</div>

                                            @endif
                                            @if($ins_courses_item->discount_price == NULL)
                                    ...
                                    <div class="card-body">
                                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">{{$ins_courses_item->label}}</h6>
                                        <h5 class="card-title"><a href="course-details.html">{{$ins_courses_item->course_name}}</a></h5>
                                        <p class="card-text"><a
                                                href="{{ route('instructor.details', $ins_courses_item->instructor_id) }}">{{$course['user']['name']}}</a>
                                        </p>
                                        <div class="rating-wrap d-flex align-items-center py-2">
                                            <div class="review-stars">
                                                <span class="rating-number">4.4</span>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            @if ($ins_courses_item->discount_price == NULL)
                                                <p class="text-black card-price font-weight-bold">
                                                    ${{ $ins_courses_item->selling_price }}
                                                </p>
                                            @else
                                                <p class="text-black card-price font-weight-bold">
                                                    ${{ $ins_courses_item->discount_price }} <span
                                                        class="before-price font-weight-medium">${{ $ins_courses_item->selling_price }}</span>
                                                </p>
                                            @endif
        ...
        <div class="modal-content">
            <div class="modal-header border-bottom-gray">
                <div class="pr-2">
                    ...
                    <se_name class="modal-title fs-19 font-weight-semi-bold lh-24" id="previewModalTitle">
                        {{$course->course_name}}
                    </se_name>
                </div>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <video controls crossorigin playsinline poster="{{url($course->course_image)}}" id="player">
                    <!-- Video files -->
...
<!-- ============================================================ End Models Start Here -->@endsection