        ...
        <div class="breadcrumb-content">
            <div class="media media-card align-items-center pb-4">
                <div class="media-img media--img media-img-md rounded-full">
                    <img class="rounded-full" src="{{!empty($instructor->photo)
    ...
    : url('upload/default.png')
                ...
                <div class="media-body">
                    ...
                    <span class="d-block lh-18 pt-1 pb-2">Joined
                        {{$instructor->created_at == null ? $instructor->updated_at->diffForHumans() : 'few years ago'}}</span>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="counter-item">
                        ...
                        <h4 class="counter__title counter text-color-4 fs-35">{{ count($ins_courses) }}</h4>
...
<section class="course-area section-padding">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between pb-3">
            ...
            <span class="ribbon ribbon-lg">{{count($ins_courses)}}</span>
        </div>
        <div class="divider"><span></span></div>
        <div class="row pt-30px">
            @foreach ($ins_courses as $item)
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1{{$item->id}}">
                                <div class="card-image">
                                    <a href="{{route('course.details', [$item->id, $item->course_name_slug])}}" class="d-block">
                                        <img class="card-img-top lazy" src="{{url($item->course_image)}}" data-src="images/img8.jpg"
                                            alt="Card image cap">
                                    </a>
                                    @php
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title"><a href="course-details.html">{{$item->course_name}}</a></h5>
                                    <p class="card-text"><a
                                            href="{{ route('instructor.details', $item->instructor_id) }}">{{$item['user']['name']}}</a>
                                    </p>
                                        ...
                                        @else
                                            <p class="text-black card-price font-weight-bold">
                                                ${{ $item->discount_price }} <span
                                                    class="before-price font-weight-medium">${{ $item->selling_price }}</span>
                                            </p>
                                        @endif
                                        <div class="icon-element icon-element-sm shadow-sm cursor-pointer" id="{{$item->id}}"
                                            onclick="addToWishList(this.id)" title="Add to Wishlist">
...
<!-- ToolTips -->
@foreach ($ins_courses as $courseItem)
