        ...
        <div class="row pt-50px">
            <div class="mx-auto col-lg-10">
                <div class="card card-item">
                    <div class="card-body">
                        <form method="post" class="row" action="{{ route('store.instructor')}}">
                            @csrf
            ...
            " type="text" name="name" placeholder="e.g. Alex">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="la la-map-location input-icon"></span>
                                </div>
                                @error('address')
                                    <span class="text-red-500 text-bold">{{$message}}</span>
                                @enderror
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    @error('phone')
                                        is-invalid
                                    @enderror
                                    " type="text" name="phone" placeholder="e.g. 12345 Little Baker St, Melbourne">
                                    <span class="la la-map-phone input-icon"></span>
                                </div>
                                @error('phone')
                                    <span class="text-red-500 text-bold">{{$message}}</span>
                                @enderror
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="la la-map-lock input-icon"></span>
                                </div>
                                @error('password')
                                    <span class="text-red-500 text-bold">{{$message}}</span>
                                @enderror
