        ...
        <div id="tooltip_content_1">
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <h5 class="pb-1 card-title"><a href="course-details.html">The Business Intelligence Analyst Course
                            2021</a></h5>
    ...
    <div class="tooltip_templates">
        <div id="tooltip_content_2">
            <div class="card card-item">
                <div class="card-body">
                    <p class="pb-2 card-text">By <a href="teacher-detail.html">Jose Portilla</a></p>
                    <h5 class="pb-1 card-title"><a href="course-details.html">Ultimate Adobe Photoshop Training: From
    ...
    <div class="tooltip_templates">
        <div id="tooltip_content_3">
            <div class="card card-item">
                <div class="card-body">
                    <p class="pb-2 card-text">By <a href="teacher-detail.html">Jose Portilla</a></p>
                    <h5 class="pb-1 card-title"><a href="course-details.html">The Complete WordPress Website Business
                            Course</a></h5>
                    <div class="pb-1 d-flex align-items-center">
                        <h6 class="mr-2 ribbon fs-14">Bestseller</h6>
                        <p class="text-success fs-14 font-weight-medium">Updated<span
    ...
    <div class="tooltip_templates">
        <div id="tooltip_content_4">
            <div class="card card-item">
                <div class="card-body">
                    <p class="pb-2 card-text">By <a href="teacher-detail.html">Jose Portilla</a></p>
                    <h5 class="pb-1 card-title"><a href="course-details.html">The Ultimate Drawing Course - Beginner to
                            Advanced</a></h5>
                    <div class="pb-1 d-flex align-items-center">
                        <h6 class="mr-2 ribbon fs-14">Bestseller</h6>
                        <p class="text-success fs-14 font-weight-medium">Updated<span
    ...
    <div class="tooltip_templates">
        <div id="tooltip_content_5">
            <div class="card card-item">
                <div class="card-body">
                    <p class="pb-2 card-text">By <a href="teacher-detail.html">Jose Portilla</a></p>
                    <h5 class="pb-1 card-title"><a href="course-details.html">The Complete Digital Marketing Course - 12
                            Courses in 1</a></h5>
                    <div class="pb-1 d-flex align-items-center">
                        <h6 class="mr-2 ribbon fs-14">Bestseller</h6>
                        <p class="text-success fs-14 font-weight-medium">Updated<span
