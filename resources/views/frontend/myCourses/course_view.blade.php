@include('frontend.myCourses.body.header')
                                    ...
                                    <div class="lecture-overview-wrap">
                                        ...
                                        <div class="lecture-overview-item">
                                            <div class="lecture-overview-stats-wrap d-flex">
                                                ...
                                                <div class="lecture-overview-stats-item">
                                                    <ul class="generic-list-item">
                                                        <li><span>Lectures:</span>{{$course->course->resources}}</li>
                                    ...
                                    <div class="footer-item">
                                        <a href="index.html">
                                            <img src="{{asset('frontend/images/logo.png')}}" alt="footer logo"
                                                class="footer__logo" width="150px">
                                        </a>
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-header" id="headingOne">
                                                                        <button class="btn btn-link" type="button" data-toggle="collapse"
                                                                            ...
                                                                            <i class="la la-angle-down"></i>
                                                                            <i class="la la-angle-up"></i>
                                                                            <span class="fs-15"> Section 1: {{$sec->section_title}}</span>
                                                                            <span class="course-duration">
                                                                                <span>{{ count($lecture) }}</span>
                                                                            </span>
                                                                        </button>
                                                                    </div><!-- end card-header -->
                                                                    <div id="collapseOne{{$sec->id}}" class="collapse show" aria-labelledby="headingOne"
                                                                                        ...
                                                                                        <div class="course-item-content-wrap">
                                                                                            <div class="custom-control custom-checkbox">
                                                                                                <input type="checkbox" class="custom-control-input"
                                                                                                    id="courseCheckbox{{$lect->id}}" required>
                                                                                                <label class="custom-control-label custom--control-label"
                                                                                                    for="courseCheckbox{{$lect->id}}"></label>
                                                                                            </div><!-- end custom-control -->
                                                                                            <div class="course-item-content">
