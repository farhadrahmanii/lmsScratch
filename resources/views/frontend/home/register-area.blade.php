        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="card card-item">
                    <div class="card-body">
                        <h3 class="pb-2 fs-24 font-weight-semi-bold">Receive Free Courses</h3>
            ...
            <div class="ml-auto col-lg-6">
                <div class="register-content">
                    <div class="section-heading">
                        <h5 class="mb-2 ribbon ribbon-lg">Register</h5>
                    ...
                    <div class="btn-box pt-35px">
                        <a href="sign-up.html" class="btn theme-btn"><i class="mr-1 la la-user"></i>Get Started</a>
                    </div>
