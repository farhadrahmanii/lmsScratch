            ...
            <div class="col-lg-6">
                <div class="pb-5 about-content">
                    <div class="section-heading">
                        <h5 class="mb-2 ribbon ribbon-lg">About us</h5>
                    ...
                    <div class="pt-4 pb-3 row">
                        <div class="col-lg-4 responsive-column-half">
                            <div class="mb-3 info-icon-box">
                                ...
                                <h4 class="pt-3 fs-20 font-weight-semi-bold">130,000 Courses</h4>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="mb-3 info-icon-box">
                                ...
                                <h4 class="pt-3 fs-20 font-weight-semi-bold">Live Learning</h4>
                            </div><!-- end info-icon-box -->
                        </div><!-- end col-lg-4 -->
                        <div class="col-lg-4 responsive-column-half">
                            <div class="mb-3 info-icon-box">
                                ...
                                <h4 class="pt-3 fs-20 font-weight-semi-bold">Expert Teachers</h4>
                            </div><!-- end info-icon-box -->
                        </div><!-- end col-lg-4 -->
                    </div><!-- end row -->
                    <div class="btn-box">
